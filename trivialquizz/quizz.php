...
<html lang="en" dir="ltr">
  ...
  <body>
                    ...
                    <div class="card-body">
                      <h3><?=$quizz['nom']?></h3>
                        <p>Nombre de questions: <span class="badge badge-pill badge-info"><?=$nbrQuestByQuizz[$quizz['id']]?></span><br>
                          Durée: <span class="badge badge-pill badge-info"><?=timeToString($quizzesDuration[$quizz['id']]['temps']*(1-4*$quizzesDuration[$quizz['id']]['malus']/100))?></span>
    ...
    function displayScoreBoard(){
      ...
      maxDuration = ( duration.temps * ( 1 - (difficulty-1) * duration.malus/ 100 ) ) * 1000;
